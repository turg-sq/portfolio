    ...
    <section id="goals" className="goals section">
      <div className="content goals-content">
        ...
        <div className="goal-grid">
          <motion.article className="goal-card goal-card--learning" {...enter(0)}><div className="goal-copy"><span className="goal-number">01</span><h3>趣味学习</h3><p>用可探索的内容，让学习自然发生。</p></div><div className="goal-proof"><img src="/assets/projects/baby-classroom/images/Frame 33897.png" alt="趣味科学实验入口" /></div></motion.article>
          ...
          <motion.article className="goal-card goal-card--feedback" {...enter(.16)}><div className="goal-copy"><span className="goal-number">03</span><h3>活动激励</h3><p>通过限时活动和奖励机制，提升孩子的参与感。</p></div><div className="goal-proof"><img className="goal-proof__primary" src="/assets/projects/baby-classroom/images/弹窗.png" alt="奖励活动反馈" /></div></motion.article>
          <motion.article className="goal-card goal-card--friendly" {...enter(.24)}><div className="goal-copy"><span className="goal-number">04</span><h3>儿童友好</h3><p>更大、更清晰、更容易理解的界面。</p></div><div className="goal-proof"><img className="goal-proof__primary" src="/assets/projects/baby-classroom/images/Frame 33898.png" alt="儿童功能图标" /></div></motion.article>
        </div>
      </div>
    </section>
  )
