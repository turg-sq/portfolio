export type ProjectDestination=
  ...
  | {destinationType:'video';videoSrc:string}
...
export const spiralProjects:SpiralProject[]=[
  ...
  {id:'red-sun-duck-egg',slug:'red-sun-duck-egg',index:'04',title:'红太阳咸鸭蛋包装设计',subtitle:'红太阳品牌包装系统',year:'2026',category:'Branding / Packaging',cover:'/assets/projects/red-sun-duck-egg/cover.png',coverVideo:'/assets/projects/red-sun-duck-egg/shot_01.mp4',aspectRatio:3/2,themeColor:'#bc5948',destinationType:'internal',route:'/projects/red-sun-duck-egg'},
  ...
  {id:'mango-tv-video',slug:'mango-tv-video',index:'06',title:'视频作品',subtitle:'芒果TV Motion Design',year:'2026',category:'Video / Motion',cover:'/assets/projects/mango-tv-video/cover.webp',aspectRatio:16/9,themeColor:'#f4c13f',destinationType:'video',videoSrc:'/assets/projects/mango-tv-video/m.mp4'},
  {id:'buchengfangyuan',slug:'buchengfangyuan',index:'07',title:'不成方圆',subtitle:'微短剧视觉设计',year:'2026',category:'数字影像',cover:'/assets/projects/buchengfangyuan/cover.webp',aspectRatio:16/9,themeColor:'#c69b59',destinationType:'video',videoSrc:'/assets/projects/buchengfangyuan/buchengfangyuan.mp4'},
]

export type VisualSlot={slotIndex:number;id:string;cover:string;coverVideo?:string;aspectRatio:number;themeColor:string;projectIndex:number|null}
...
export const visualSlots:VisualSlot[]=Array.from({length:24},(_,slotIndex)=>{
  ...
  return {slotIndex,id:`${asset.id}-${slotIndex}`,cover:asset.cover,coverVideo:asset.coverVideo,aspectRatio:asset.aspectRatio,themeColor:asset.themeColor,projectIndex:asset.projectIndex}
})
