...
export default function RedSunDuckEggPage({project,nextProject,onBack,onOpenProject}:RedSunDuckEggPageProps){
  ...
  return <main className="red-sun-page">
    ...
    <section className="red-sun-brand-story red-sun-section">
      <div className="red-sun-brand-story__layout red-sun-grid"><aside><SectionHeading index="05" english="BRAND STORY" title="品牌故事" /><ul><li>品牌传承</li><li>生态优养</li><li>古法腌制</li><li>真材实料</li></ul></aside><RevealImage src="brand-story.png" alt="红太阳高邮咸鸭蛋品牌故事长页" /></div>
    </section>
